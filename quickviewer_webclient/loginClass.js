...
class LoginClass 
{
    ...
    createLoginHtml()
    {
        ...
        // QuickViwer Login Form
        this.titleLabel = document.createElement('div');
        this.titleLabel.id = 'titleLabel';
        this.titleLabel.innerHTML = 'Connect to remote device';
		...
		*/
        ...
        this.labelPass.style.cssText = cssLabel + 'top: 45%; ';
        ...
        this.inputLogin.attributes.required = "required";
...
*/		
        ...
        this.inputPass.attributes.required = "required";
        this.inputPass.style.cssText = cssInput + 'top: 55%; ';
    ...
    showWrongRequest()
    {
        ...
        this.statusLabel.innerHTML = 'ERROR: Incorrect ID or Password!';
    ...
    btnSubmitClicked()
    {
		...
		// Start the chain of events that will begin the login process
		
		this.dataManager.startLogin(this.inputLogin.value, this.inputPass.value)
...
*/		
    ...
    {
		console.log("buttonDesktopClicked()");
