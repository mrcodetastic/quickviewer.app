class DisplayField
{
    constructor()
    {
        ...
        this.width = 1; 	// real width of remote hose
        this.height = 1;	// real height of remote host
    ...
    initDisplayField()
    {
		...
		//console.log(this.cursorContainer);
		//console.log(this.canvasRect);
		//console.log(this.deltaRect);
    }
    ...
    initTouchField()
    {
        ...
        this.cursorContainer.addEventListener("touchstart", this.touchPress.bind(this));
        this.cursorContainer.addEventListener("touchmove", this.touchMove.bind(this));
        this.cursorContainer.addEventListener("touchend", this.touchRelease.bind(this));
	...
	printTouchInfo()
	{
		console.log("stepPress : " + this.stepPress);
		console.log("stepMove :  " + this.stepMove);
		console.log("stepRelease :  " + this.stepRelease);		
    ...
    touchPress(e)
    {
        ...
        if(e.touches.length === 1 && !this.isScaling)
        {
			...
			this.dataManager.sendInput(KEY_SET_CURSOR_POS,this.touchX,this.touchY);
    ...
    touchMove(e)
    {
        ...
        if(e.touches.length === 1 && !this.isScaling)
        {
            ...
            {
                this.isPressed = true;
                this.dataManager.sendInput(KEY_SET_MOUSE_KEY,0,1);
            }
    ...
    touchRelease(e)
    {
        ...
        if(this.isPressed)
            this.dataManager.sendInput(KEY_SET_MOUSE_KEY,0,0);
    }
    ...
    touchWaiter()
    {
        ...
        {
            this.dataManager.sendInput(KEY_SET_MOUSE_KEY,2,1);
            this.dataManager.sendInput(KEY_SET_MOUSE_KEY,2,0);
        }
    ...
    calcCursorPos(x, y)
    {
        ...
        this.dataManager.sendInput(KEY_SET_CURSOR_POS,this.cursorPosX,this.cursorPosY);
        this.updatePositions();
    }
    ...
    mouseKeyStateChanged(event)
    {
		...
		{
            this.dataManager.sendInput(KEY_SET_MOUSE_KEY,event.button,0);
		//console.log("mouse up");
		}

        else if(event.type == 'mousedown')
		{
            this.dataManager.sendInput(KEY_SET_MOUSE_KEY,event.button,1);
    ...
    mouseWheelEvent(event)
    {
        ...
        if(event.deltaY > 0)
            this.dataManager.sendInput(KEY_SET_MOUSE_WHEEL,0,1);
        else this.dataManager.sendInput(KEY_SET_MOUSE_WHEEL,0,0);
    }
    ...
    keyStateChanged(event)
    {
        ...
        this.dataManager.sendInput(KEY_SET_KEY_STATE,event.keyCode,state);
    ...
    leavePageEvent()
    {
        ...
        for(var i=0;i<len;++i)
            this.dataManager.sendInput(KEY_SET_KEY_STATE,this.keyPressedList[i],false);
    }
    ...
    setImageParameters(w, h, r) // receive real dimensions of host
    {
		console.log("w: " + w);
		console.log("h: " + h);
		console.log("r: " + r);
    ...
    setImageData(posX, posY, b64data, tileNum)
    {
        ...
        image.onload = function()
        {
            ...
            this.dataManager.sendInput(KEY_TILE_RECEIVED,this.tileNum,0);
        }

        image.src = b64data;
    }

    setImageScreenData(b64data)
    {
        if(!this.ctx)
            return;
    ...
    keyboardKeyStateChanged(key,state,event)
    {
        ...
        this.dataManager.sendInput(KEY_SET_KEY_STATE,num,state);
    }
